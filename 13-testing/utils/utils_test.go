...
*/
func Benchmark_IsPrime_73(b *testing.B) {
	for i := 0; i < b.N; i++ {
		utils.IsPrime(73)
	}
}

func Benchmark_IsPrime2_73(b *testing.B) {
	for i := 0; i < b.N; i++ {
		utils.IsPrime2(73)
	}
}

func Benchmark_IsPrime3_73(b *testing.B) {
	for i := 0; i < b.N; i++ {
		utils.IsPrime3(73)
	}
}

func Benchmark_IsPrime4_73(b *testing.B) {
	for i := 0; i < b.N; i++ {
		utils.IsPrime4(73)
	}
}
